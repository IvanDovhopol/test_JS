...
//   (genre, i, arr) => arr.indexOf(genre) === i,
// );
...
// const totalPlayTime = playtimes.reduce((a, b) => a + b);
// console.log('total:', totalPlayTime);

// const averagePlayTime = totalPlayTime / playtimes.length;
// console.log('total average:', averagePlayTime);
...
//   (total, player) => total + player.playtime,
//   0,
// );
// console.log('total playtime:', totalAveragePlaytimePerGame);

// const avaragreTotalPlaytime = totalAveragePlaytimePerGame / players.length;
// console.log('playtime avarege:', avaragreTotalPlaytime);
...
// const avarageUsersBalance = calculateTotalBalance(users) / users.length;
// console.log('avarege balance:', avarageUsersBalance);
...
//   users.reduce((total, user) => [...total, ...user.friends], []).length;
...
// console.log('asc:', ascendingReleaseDates);

// const descendingReleaseDates = [...releaseDates].sort((a, b) => b - a);
// console.log('desc:', descendingReleaseDates);
...
// console.log('asc:', authorsInAlphabetOrder);

// const authorsInReversedOrder = [...authors].sort((a, b) => b.localeCompare(a));
// console.log('desc:', authorsInReversedOrder);
...
// );
// console.log('alpha:', sortedByAuthorName);

// const sortedByReversedAuthorName = [...books].sort((firstBook, secondBook) =>
//   secondBook.author.localeCompare(firstBook.author),
// );
// console.log('alpha reverse:', sortedByReversedAuthorName);

// const sortedByAscendingRating = [...books].sort(
//   (firstBook, lastBook) => firstBook.rating - lastBook.rating,
// );
// console.log('asc:', sortedByAscendingRating);

// const sortedByDescentingRating = [...books].sort(
//   (firstBook, lastBook) => lastBook.rating - firstBook.rating,
// );
// console.log('desc:', sortedByDescentingRating);
...
//   users.sort((firstUser, lastUser) => firstUser.balance - lastUser.balance);
...
//     .filter((book, i, arr) => arr.indexOf(book) === i)
//     .sort((a, b) => a.localeCompare(b));
// console.log(getSortedFriends(users));

// 28 LAST this colection ))
